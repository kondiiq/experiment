...
entity Tasks: cuid, managed {
    ...
    description : String(255);
    noTasks     : Integer;
    subtasks    : Association to many Subtasks on subtasks.task = $self;
...
entity Subtasks : cuid, managed {
    ...
    comments    : Association to many Comments on comments.subtask = $self;
    attachments : Association to many Attachments on attachments.subtask = $self;
}
...
entity Teams : cuid, managed {
    name   : String(100);
    users  : Association to many Users on users.team = $self;
}
...
entity Users : managed {
    ...
    subtasks        : Association to many Subtasks on subtasks.assigned = $self;
